...
//
//
// The boundary conditions for these test are:
//  NONE: No DO or do_id rows, or No Foreign Reference Tables involved
...
class ArchiverDataObjectsTester
{
...
public function initialize()
{
    ...
    // Instantiate a ArchiverDataObjects, and initialize it.
...
public function test()
{
    ...
    // To prevent accidentally running this on the wrong server, (e.g. the Production Master),
...
public function did_test_pass_or_fail($test_number)
{
    ...
    {
        echo "\nArchiverDataObjects Test A.1: FAILURE:"; 
        echo "\n\tTable   : $row[0]"; 
        echo "\n\tBefore  : $row[1]"; 
        echo "\n\tAfter   : $row[2]"; 
        echo "\n\tExpected: $row[3]"; 
    ...
    echo "\nArchiveDataObjectsTester: Test $test_number:\t$grade";
    echo "\n";
...
public function exit_on_sql_error($error_number, $error_description, $sql_statement)
{
    if ($error_number)
    {
        echo "\n\nArchiverDataObjectsTester.exit_on_sql_error()";
        //echo "\n\n$sql_statement";
